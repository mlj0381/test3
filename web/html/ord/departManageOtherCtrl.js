...
departManageApp.controller("departManageCtrl", ["$scope","commonService","$timeout",function($scope,commonService,$timeout) {
	var billIngManage={
			...
			toView:function(trackingNum){
				...
				window.open("/ord/ordBillingDetail.html?view=1&orderId="+orderId+"&trackingNum="+trackingNum+"&type=3&ver=${ver}");
			},
			...
			toTransitOutgoingManage: function(){
				commonService.openTab("1111110001","新增中转外发","/ord/addDepartOtherTransitUser.html?type=2");
			},
