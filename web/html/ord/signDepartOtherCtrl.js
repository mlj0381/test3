...
var addDepartOtherApp = angular.module("signDepartOtherApp", ['commonApp']);
addDepartOtherApp.controller("signDepartOtherCtrl", ["$scope","commonService","$timeout",'$filter',function($scope,commonService,$timeout,$filter) {
	...
	var addDepart={
		...
		init:function(){
			...
			var isMakeup = getQueryString("isMakeup");
			$scope.isMakeup = isMakeup;
			this.bindEvent();
...
//		},
		...
		doQuery : function(){
				...
				$scope.query.isMakeup = $scope.isMakeup;
