        ...
        departApp.controller("departCtrl", ["$scope","commonService","$timeout","$sce",function($scope,commonService,$timeout,$sce) {
...
//                		console.log(m);
            		...
            		selectOne : function(orderId){
            			if(document.getElementById("checkbox"+orderId) == undefined){
            				return false;
            			}
