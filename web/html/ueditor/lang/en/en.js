...
UE.I18N['en'] = {
    ...
    'insertvideo':{
        ...
        'loading':" &nbsp;The video is loading, please wait钬?,
    ...
    'charts':{
        'static':{
            ...
            'lang_cahrt_tip_description': '浠呴ゼ锲炬湁鏁堬紝 褰挞紶镙囩Щ锷ㄥ埌楗煎浘涓浉搴旗殑鍧椾笂镞讹紝鎻愮ず妗嗗唴镄勬枃瀛楃殑鍓岖紑',
            'lang_chart_data_unit': 'Unit',
            'lang_chart_data_unit_title': 'unit:',
            'lang_chart_data_unit_description': '鏄剧ず鍦ㄦ疮涓暟鎹偣涓婄殑鏁版嵁镄勫崟浣嶏紝 姣斿锛?娓╁害镄勫崟浣?鈩?,
