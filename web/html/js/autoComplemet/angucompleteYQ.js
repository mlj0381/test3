...
angular.module('angucompleteYQ', [] )
    ...
    return {
        ...
        template: '<div class="angucomplete-holder">'+
        			...
        			'	<div class="angucomplete-searching" ng-show="searching">正在搜索中...</div>'+
        			'	<div class="angucomplete-searching" ng-show="!searching && (!results || results.length == 0)">找不到信息</div>'+
