var doSignOrdersApp = angular.module("doSignOrdersApp", ['commonApp','tableCommon']);
doSignOrdersApp.controller("doSignOrdersCtrl", ["$scope","commonService","$timeout",function($scope,commonService,$timeout) {
	var doSignOrders={
		init:function(){
			this.bindEvent();		
		},
		...
		bindEvent:function(){
		    ...
		    $timeout(function(){
				$scope.table.mouseleave = doSignOrders.mouseleave;
				$scope.table.enterCallback = doSignOrders.enterCallback;
			},200);
		},
