...
var orderDetailInfoApp = angular.module("trackDetailInfoApp", ['commonApp','angucomplete','ngTouch','billingCommon']);
orderDetailInfoApp.controller("trackDetailInfoCtrl", ["$scope","commonService","$timeout",function($scope,commonService,$timeout) {
