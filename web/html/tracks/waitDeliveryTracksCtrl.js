var waitDeliveryTracksApp = angular.module("waitDeliveryTracksApp", ['commonApp','tableCommon']);
waitDeliveryTracksApp.controller("waitDeliveryTracksCtrl", ["$scope","commonService","$timeout",function($scope,commonService,$timeout) {
	var waitDeliveryTracks={
		init:function(){
			this.bindEvent();
		...
		bindEvent:function(){
			$scope.head=waitDeliveryTracks.head;
