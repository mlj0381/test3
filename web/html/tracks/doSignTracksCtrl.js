var doSignTracksApp = angular.module("doSignTracksApp", ['commonApp','tableCommon']);
doSignTracksApp.controller("doSignTracksCtrl", ["$scope","commonService","$timeout",function($scope,commonService,$timeout) {
	var doSignTracks={
		init:function(){
			this.bindEvent();
