...
function dayRedraw() {
	...
	$.ajax({
		type : "GET",
		url : "visit.ajax?cmd=queryGoodsAndCars",
		data : "type=0",// {username:$("#username").val(),
						// content:$("#content").val()}
		dataType : "json",
		async : false,
		success : function(data) {
	...
	plot = $.plot($("#statsChart"), [ {
		...
		colors : [ "#30a0eb", "#30a0eb" ],
		xaxis : {
			ticks : [ [ 1, "1镞? ], [ 2, "2镞? ], [ 3, "3镞? ], [ 4, "4镞? ], [ 5, "5镞? ], [ 6, "6镞? ], [ 7, "7镞? ], [ 8, "8镞? ],
			          [ 9, "9镞? ], [ 10, "10镞? ], [ 11, "11镞? ], [ 12, "12镞? ], [ 13, "13镞? ], [ 14, "14镞? ], [ 15, "15镞? ], 
			          [ 16, "16镞? ], [ 17, "17镞? ], [ 18, "18镞? ], [ 19, "19镞? ], [ 20, "0镞? ], [ 21, "21镞? ], [ 22, "22镞? ], 
			          [ 23, "23镞? ], [ 24, "24镞? ], [ 25, "25镞? ], [ 26, "26镞? ], [ 27, "27镞? ], [ 28, "28镞? ], [ 29, "29镞? ], 
			          [ 30, "30镞? ], [ 31, "31镞? ] ],
			font : {
				size : 12,
				family : "Open Sans, Arial",
