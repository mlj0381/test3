var myApp = angular.module("zxApplicationApp", ['commonApp']);
myApp.controller("zxApplicationCtrl", ["$scope","commonService","$timeout",function($scope,commonService,$timeout) {
	var myManage={
		init:function(){
			$scope.query = {};
			$scope.add = {};
...
//				if (document.getElementById("checkbox").checked) {
		...
		getApplicationById:function(){
			...
			commonService.openTab(batchNum.join(","),"提现审批","/sche/cash/zxAuthApplication.html?id="+batchNum.join(","));
		},
		/**提现查看**/
		getApplicationByIdView:function(){
			...
			commonService.openTab(batchNum.join(","),"提现明细","/sche/cash/zxViewApplication.html?id="+batchNum.join(","));
		},
		/**申请提现**/
		doSave:function(){
