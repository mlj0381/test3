...
//				if (document.getElementById("checkbox").checked) {
		...
		doQuery:function(){
			...
			if($scope.query.cityId=="-1"||$scope.query.cityId==undefined){
				myManage.params.cityId="0";
			}
			...
			myManage.params.doObjName=$scope.query.workerName;
			myManage.params.doTel=$scope.query.workerLoginAcct;
			myManage.params.isTmail=$scope.query.isTmail;
			var url = "creditManageBO.ajax?cmd=doQueryKpi";
			$timeout(function(){
				$scope.page.load({
							url:url,
