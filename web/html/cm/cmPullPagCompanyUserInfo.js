var cmPullPagCompanyUserInfoApp = angular.module("cmPullPagCompanyUserInfoApp", ['commonApp']);
cmPullPagCompanyUserInfoApp.controller("cmPullPagCompanyUserInfoCtrl", ["$scope","commonService","$timeout",function($scope,commonService,$timeout) { 
	var userInfo ={
		init:function(){
			this.queryOrg();
		...
		updateUser:function(){
			...
			commonService.openTab(selectedDate.userId,"修改普通员工",encodeURI("/cm/addPullPagCmUserInfo.html"+queryParamStr));
		},
		addUser:function(){
			commonService.openTab("222222","新增普通员工","/cm/addPullPagCmUserInfo.html");
		},
