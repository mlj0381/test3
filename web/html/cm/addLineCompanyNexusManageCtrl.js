var addLineCompanyNexusManageApp = angular.module("addLineCompanyNexusManageApp", ['commonApp']);
addLineCompanyNexusManageApp.controller("addLineCompanyNexusManageCtrl", ["$scope","commonService","$timeout",function($scope,commonService,$timeout) {
	var addLineCompanyNexusManage={
		//一进入调用
		init:function(){
	...
	addLineCompanyNexusManage.init();
}]);
