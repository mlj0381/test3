var cmUserInfoCompanyApp = angular.module("cmUserInfoCompanyApp", ['commonApp']);
cmUserInfoCompanyApp.controller("cmUserInfoCompanyCtrl", ["$scope","commonService","$timeout",function($scope,commonService,$timeout) { 
	var userInfo ={
		init:function(){
			this.queryOrg();
		...
		updateUser:function(){
			...
			commonService.openTab(selectedDate.userId,"修改普通员工",encodeURI("/cm/addCmUserCompany.html"+queryParamStr));
		},
		addUser:function(){
			commonService.openTab("222222","新增普通员工","/cm/addCmUserCompany.html");
		},
