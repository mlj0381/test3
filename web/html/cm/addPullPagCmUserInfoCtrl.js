function changeTabCallback(){
	...
	var appElement = document.querySelector('[ng-controller=addPullPagCmUserInfoCtrl]');
	var scope=angular.element(appElement).scope();
	scope.queryRoleOfCompany();
}

var addPullPagCmUserInfoApp = angular.module("addPullPagCmUserInfoApp", ['commonApp']);
addPullPagCmUserInfoApp.controller("addPullPagCmUserInfoCtrl", ["$scope","commonService","$timeout",function($scope,commonService,$timeout) {
	...
	var userInfo={
			...
			queryUserInfoType:function(){
				commonService.postUrl("staticDataBO.ajax?cmd=selectSysStaticDataByCodeUserType",{codeType:"USER_TYPE_PULLPAGCOMPANY"},function(data){
					if(data != null && data != undefined && data != ""){
