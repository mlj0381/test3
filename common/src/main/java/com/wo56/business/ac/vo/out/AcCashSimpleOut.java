...
public class AcCashSimpleOut{
	...
	private static final long serialVersionUID = 1200002030408414345L;
	  ...
	  public String[] getNoFiled() {
		String[]  noFileds = new String[]{"deliveryType","serviceType","releaseNote","isVerification",
				                           ...
				                           "noFiled","destCityNameAnddestCountyName","sellerTenantId",
				                           "tenantId","sellerOrderId","exceptionFee","freeMoney","upstairsFee"};
	...
	public void setNoFiled(String[] noFiled) {
	  ...
	  private Double goodsVolumePrice;
	...
	public Double getGoodsVolumePrice() {
		return goodsVolumePrice;
	}
	public void setGoodsVolumePrice(Double goodsVolumePrice) {
		this.goodsVolumePrice = goodsVolumePrice;
	}
	...
	private long orderId; //订单号
	  ...
	  private Double freeMoneyDouble;
	...
	public Double getFreeMoneyDouble() {
		setFreeMoneyDouble(CommonUtil.getDoubleFormatLongMoney(freeMoney,2)); 
		return freeMoneyDouble;
	}
	public void setFreeMoneyDouble(Double freeMoneyDouble) {
		this.freeMoneyDouble = freeMoneyDouble;
	}
	...
	public String getSignDateFormat() {
		if(getSignDate() != null){
			setSignDateFormat(DateUtil.formatDate(getSignDate(), "yyyy-MM-dd"));
		}
	...
	public String getCreateDateFormat() throws ParseException {
		if(getCreateDate() != null){
			setCreateDateFormat(DateUtil.formatDate(getCreateDate(), "yyyy-MM-dd"));
		}
	...
	public String getOrgIdName() {
		setOrgIdName(orgId != null ? OraganizationCacheDataUtil.getOrgName(orgId) : "");
		return orgIdName;
	}
	...
	public String getCurrentOrgIdName() {
		setCurrentOrgIdName(currentOrgId != null ? OraganizationCacheDataUtil.getOrgName(currentOrgId) : "");
	...
	//所有的费用需翻译
	  ...
	  private Long packingCosts;//装卸费
	  private Long discount; //回扣
	  private Long exceptionFee; //异常费用合计
	  ...
	  private Double packingCostsDouble;//包装费
	  private Double discountDouble; //回扣
	  private Double exceptionFeeDouble; //异常费用合计
	...
	public Long getExceptionFee() {
		return exceptionFee;
	}
	public void setExceptionFee(Long exceptionFee) {
		this.exceptionFee = exceptionFee;
	}
	public Double getExceptionFeeDouble() {
		setExceptionFeeDouble(CommonUtil.getDoubleFormatLongMoney(exceptionFee,2));
		return exceptionFeeDouble;
	}
	public void setExceptionFeeDouble(Double exceptionFeeDouble) {
		this.exceptionFeeDouble = exceptionFeeDouble;
	}
	...
	public String getDesName() {
		String s =  getDestCountyName();
		setDesName(StringUtils.isNotEmpty(s) ? destProvinceName + destCityName + s: destProvinceName + destCityName);
		return desName;
	}
