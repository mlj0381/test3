...
/**
 * OrderInfoTmsError entity. @author MyEclipse Persistence Tools
 */

@SuppressWarnings("serial")
public class OrderInfoTmsError implements java.io.Serializable {
	...
	/** default constructor */
	public OrderInfoTmsError() {
	}

	/** minimal constructor */
	public OrderInfoTmsError(Long orderId, Long ordsId, String orderNumber,
			Date createTime) {
