...
public class OrdImportBillInfoOut extends BaseOutParamVO {
	...
	private Integer iSigningType;
	
	public Integer getiSigningType() {
		return iSigningType;
	}

	public void setiSigningType(Integer iSigningType) {
		this.iSigningType = iSigningType;
	}
