...
public class OrderTrInfoSimpleOut extends BaseOutParamVO {
	/**
	 * 
	 * 
	 * 注意 ：出参
	...
	public String[] getNoFiled() {
		String[] noFileds = new String[] { "deliveryType", "serviceType",
				"releaseNote", "isVerification", "isImportant", "isDirect",
				"postingSts", "releaseNote", "isVerification", "isImportant",
				"postingSts", "postingSts", "totalFee", "destProvince",
				...
				"noFiled" , "freeReplacement", "outgoingFee" };
	...
	private String transferArriveGoodsTime;
	private String secondTransferTime;
	private String isSeconfTrasfer;
	
	private Long freeReplacement;
	private Double freeReplacementDouble;

	
	

	public String getSecondTransferTime() {
		return secondTransferTime;
	}

	public void setSecondTransferTime(String secondTransferTime) {
		this.secondTransferTime = secondTransferTime;
	}

	public String getTransferArriveGoodsTime() {
		return transferArriveGoodsTime;
	}

	public void setTransferArriveGoodsTime(String transferArriveGoodsTime) {
		this.transferArriveGoodsTime = transferArriveGoodsTime;
	}

	public String getIsSeconfTrasfer() {
		return isSeconfTrasfer;
	}

	public void setIsSeconfTrasfer(String isSeconfTrasfer) {
		this.isSeconfTrasfer = isSeconfTrasfer;
	}

	public Double getOutgoingFeeDouble() {
		setOutgoingFeeDouble(CommonUtil.getDoubleFormatLongMoney(getOutgoingFee(), 2));
	...
	public Long getFreeReplacement() {
		return freeReplacement;
	}

	public Double getFreeReplacementDouble() {
		setFreeReplacementDouble(CommonUtil.getDoubleFormatLongMoney(freeReplacement, 2));
		return freeReplacementDouble;
	}

	public void setFreeReplacement(Long freeReplacement) {
		this.freeReplacement = freeReplacement;
	}

	public void setFreeReplacementDouble(Double freeReplacementDouble) {
		this.freeReplacementDouble = freeReplacementDouble;
	}
	...
	public String getCarrOrgIdName() {
		setCarrOrgIdName(OraganizationCacheDataUtil.getOrgName(carrOrgId));
	...
	public String getDeliveryTypeName() {
		if (deliveryType != null && deliveryType > 0) {
			setDeliveryTypeName(SysStaticDataUtil.getSysStaticData(
					"DELIVERY_TYPE", deliveryType + "").getCodeName());
		}
	...
	public String getServiceTypeName() {
		setServiceTypeName(SysStaticDataUtil.getSysStaticData(
				"SCHE_SERVICE_TYPE", serviceType + "").getCodeName());
	...
	public String getIsVerificationName() {
		setIsVerificationName(isVerification == null || !isVerification ? "否"
				: "是");
	...
	public String getOrderStateName() {
		setOrderStateName(SysStaticDataUtil.getSysStaticData(
				EnumConsts.SysStaticData.ORDER_STATE, orderState + "")
				.getCodeName());
	...
	public String getSeeOrderStateName() {
		setSeeOrderStateName(SysStaticDataUtil.getSysStaticData(
				"APP_ORDER_STATE", seeOrderState + "").getCodeName());
	...
	public String getPostingStsName() {
		if (postingSts != null && postingSts.intValue() > -1) {
			setPostingStsName(SysStaticDataUtil.getSysStaticData(
					"ORDER_POSTING_STS", postingSts.intValue() + "")
					.getCodeName());
		}
	...
	public String getDestProvinceName() {
		if (destProvince != null && (destProvince) != 0) {
			setDestProvinceName(SysStaticDataUtil.getProvinceDataList(
					"SYS_PROVINCE", destProvince + "").getName());
		}
	...
	public String getDestCityName() {
		if (destCity != null && !"".equals(destCity)) {
			setDestCityName(SysStaticDataUtil.getCityDataList("SYS_CITY",
					destCity + "").getName());
		}
		return destCityName;
	}
	...
	public String getDestCountyName() {
		if (destCounty != null) {
			setDestCountyName(SysStaticDataUtil.getDistrictDataList(
					"SYS_DISTRICT", destCounty + "").getName());
		}
	...
	public String getDistributionOrgIdName() {
		if (distributionOrgId != null) {
			setDistributionOrgIdName(OraganizationCacheDataUtil
					.getOrgName(distributionOrgId));
		}
	...
	private Double offerDouble;// ?栈蹩畹氖中?
	...
	public Double getCashPaymentDouble() {
		setCashPaymentDouble(CommonUtil
				.getDoubleFormatLongMoney(cashPayment, 2));
	...
	public Double getFreightCollectDouble() {
		setFreightCollectDouble(CommonUtil.getDoubleFormatLongMoney(
				freightCollect, 2));
	...
	public Double getMonthlyPaymentDouble() {
		setMonthlyPaymentDouble(CommonUtil.getDoubleFormatLongMoney(
				monthlyPayment, 2));
	...
	public Double getTransPaymentDouble() {
		setTransPaymentDouble(CommonUtil.getDoubleFormatLongMoney(transPayment,
				2));
	...
	public Double getReceiptPaymentDouble() {
		setReceiptPaymentDouble(CommonUtil.getDoubleFormatLongMoney(
				receiptPayment, 2));
	...
	public Double getCollectingMoneyDouble() {
		setCollectingMoneyDouble(CommonUtil.getDoubleFormatLongMoney(
				collectingMoney, 2));
	...
	public Double getProcedureFeeDouble() {
		setProcedureFeeDouble(CommonUtil.getDoubleFormatLongMoney(procedureFee,
				2));
	...
	public String getPaymentType2Name() {
		setPaymentType2Name(SysStaticDataUtil.getSysStaticData("PAYMENT_TYPE",
				paymentType2 + "").getCodeName());
	...
	public Double getInstallCostsDouble() {
		setInstallCostsDouble(CommonUtil.getDoubleFormatLongMoney(installCosts,
				2));
	...
	public Double getPickingCostsDouble() {
		setPickingCostsDouble(CommonUtil.getDoubleFormatLongMoney(pickingCosts,
				2));
	...
	public Double getHandingCostsDouble() {
		setHandingCostsDouble(CommonUtil.getDoubleFormatLongMoney(handingCosts,
				2));
	...
	public Double getPackingCostsDouble() {
		setPackingCostsDouble(CommonUtil.getDoubleFormatLongMoney(packingCosts,
				2));
	...
	public String getDestCityNameAnddestCountyName() {
		...
		setDestCityNameAnddestCountyName(StringUtils.isNotEmpty(s) ? s
				: destCityName);
